...
export IDENTITY_PROVIDER_VIRTUAL_HOST=idp.claritynlp.dev
export IDENTITY_PROVIDER_CONTAINER_PORT=5000

# IDENTITY AND ACCESS PROXY
export IDENTITY_AND_ACCESS_PROXY_VIRTUAL_HOST=api.claritynlp.dev
...
export SCHEDULER_VIRTUAL_HOST=luigi.claritynlp.dev
...
export INGEST_CLIENT_VIRTUAL_HOST=ingest.claritynlp.dev
...
export RESULTS_CLIENT_VIRTUAL_HOST=viewer.claritynlp.dev
...
export DASHBOARD_CLIENT_VIRTUAL_HOST=dashboard.claritynlp.dev

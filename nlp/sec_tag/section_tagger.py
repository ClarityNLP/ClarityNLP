...
CS_MAP_FILE = pkg_resources.resource_filename('sec_tag', 'data/concepts_and_synonyms.txt')

# name of the file containing the concept graph, generated by db-extract.py
GRAPH_FILENAME = pkg_resources.resource_filename('sec_tag', 'data/graph.txt')

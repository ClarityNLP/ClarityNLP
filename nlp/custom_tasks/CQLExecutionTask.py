...
#             # get other custom args

#             # dir containing CQL query result JSON files; will load all files
#             cql_result_file = self.pipeline_config.custom_arguments['cql_result_file']
#             # any others TBD

#             print('cql_result_file: {0}'.format(cql_result_file))
            
#             if not os.path.isfile(cql_result_file):
#                 print('File not found: "{0}"'.format(cql_result_file))
#                 return
            
#             print('loading file "{0}"'.format(cql_result_file))
#             results = _load_json_result(cql_result_file)

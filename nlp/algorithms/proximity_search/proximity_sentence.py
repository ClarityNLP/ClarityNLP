...
def get_proximity_sentenece(sentence,word1,word2,number,order = True):
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        if len(sys.argv) == 6:
            if sys.argv[5] == 'False':
                print(get_proximity_sentenece(sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4],False))
            else:
                print(get_proximity_sentenece(sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4]))
        else:
            print(get_proximity_sentenece(sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4]))
